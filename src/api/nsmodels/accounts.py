...
request_password_reset_parser.add_argument("modalEmail", required=True, type=str, help="Please enter your email address", default='satesto@example.com')

password_reset_parser = reqparse.RequestParser()
password_reset_parser.add_argument("token", required=True, type=str, help="Please provide token", default='RmYTkyNTQxZjljMSI.Z8bhDw.1YCel4ik_BUzPqPpMZDvP8TaPMM.....')
password_reset_parser.add_argument("password", required=True, type=str, help="Please enter new password", default='PAROLIparoli123')
password_reset_parser.add_argument("retype_password", required=True, type=str, help="Please repeat password", default='PAROLIparoli123')

change_password_parser = reqparse.RequestParser()
change_password_parser.add_argument("current_password", required=True, type=str, help="Please enter current password", default='PAROLIparoli123')
change_password_parser.add_argument("password", required=True, type=str, help="Please enter new password", default='PAROLIparoli123')
change_password_parser.add_argument("retype_password", required=True, type=str, help="Please repeat password", default='PAROLIparoli123')